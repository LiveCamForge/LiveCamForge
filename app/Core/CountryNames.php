...
final class CountryNames
{
    private const EN = [
        ...
        'ML' => 'Mali', 'MM' => 'Myanmar (Burma)', 'MN' => 'Mongolia', 'MO' => 'Macao SAR China',
    ...
    private const IT = [
        ...
        'ML' => 'Mali', 'MM' => 'Myanmar (Birmania)', 'MN' => 'Mongolia', 'MO' => 'RAS di Macao',
    ...
    public static function localized(string $code, string $locale): ?string
    {
        $language = strtolower((string) preg_replace('/[-_].*$/', '', trim($locale)));
        ...
        return is_array($names) ? ($names[$code] ?? null) : null;
    }

    public static function english(string $code): string
    {
        return self::EN[$code] ?? $code;
    }
}
